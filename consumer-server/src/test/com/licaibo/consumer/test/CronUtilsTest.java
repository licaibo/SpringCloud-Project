package com.licaibo.consumer.test;
...
public class CronUtilsTest {
    ...
    public static void main(String[] args) {
        ...
        /*
         * Welcome to our cron-utils usage examples. In the following lines, we will introduce you to main cron-utils
         * features so that you can start using them asap :)
         */
        ...
        /*
         * ok, up to now we just worked on cron domain. But what about execution times? We have a scheduling service, and
         * would like to display previous/next execution or time from last or to next execution. Can cron-utils help us with
         * that? Sure!
         */
        howToGetExecutionTimes();

        /*
         * To finish this demo, we would like to showcase another useful feature: human readable descriptions Cron
         * expressions are cryptic to most non-tech users: how can we bring some transparency to them? We add the cron-utils
         * dependency to the project, and ask for a human readable description!
         */
    ...
    private static void howToWithCronParser() {
        ...
        System.out
                .println(String.format("Was the parsing correct? Lets turn it to string again! original: '%s' parsed: '%s'",
    ...
    private static void howToHumanReadableDescriptions() {
        ...
        CronDescriptor descriptor = CronDescriptor.instance(Locale.CHINESE);// we support multiple languages! Just pick one!
